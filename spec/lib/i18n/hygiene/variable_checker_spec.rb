...
describe I18n::Hygiene::VariableChecker do
  ...
  let(:checker) { I18n::Hygiene::VariableChecker.new("test_key", i18n_wrapper) }
  let(:checker_markdown) { I18n::Hygiene::VariableChecker.new("test_key_markdown", i18n_wrapper) }
